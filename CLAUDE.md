...
- 項目名は、特定の著者・一冊の本の造語より、その分野で一般的・確立した呼称を優先する。出典は単一に依存せず、特定著者の整理は「整理の一つ」として明示する。経緯: [adr/20260608-prefer-established-general-naming](./adr/20260608-prefer-established-general-naming/README.md)
