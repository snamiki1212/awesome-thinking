...
### 違いが掴みにくい? — 同じお題で使い分けてみる

定義だけだと混同しがちなので、**1つのお題「アプリの解約が増えている」を4タイプで扱う**と、関わり方の違いが見えます。

| タイプ | このお題への関わり方 | 具体例 |
| --- | --- | --- |
| 🧠 メンタルモデル | 状況の**見え方**を変える（手順はない） | 「複利」のレンズ →*解約が解約を呼ぶ悪循環では?* |
| 🧩 フレームワーク | 決まった**枠に当てはめて整理**する | 「なぜなぜ分析」で*なぜ解約? →使いにくい →なぜ?…* と原因を掘る |
| 🧭 思考法 | **どの方向・姿勢**で攻めるか決める | クリティカルシンキングで*そもそも「増えている」は本当?* と前提を疑う |
| 🛠 思考術 | **すぐ打てる一手**で詰まりを動かす | リフレーミングで問いを*「継続したくなる理由は?」*に置き換える |

つまり **メンタルモデル＝見え方／思考法＝攻める方向／フレームワーク＝整理の型／思考術＝その場の一手**。
さらに詳しい比較表・関係図（思考法 ⊃ フレームワーク ⊃ 思考術）は ➡ **[docs/taxonomy.md](./docs/taxonomy.md)** へ。
